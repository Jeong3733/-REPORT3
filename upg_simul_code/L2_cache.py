...
class L2Cache:
    ...
    def read(self, address):
        ...
        if line:
            if (self._replace_pol == L2Cache.LRU or
                self._replace_pol == L2Cache.LFU):
    ...
    def load(self, address, data):
        ...
        # Select the victim
        if (self._replace_pol == L2Cache.LRU or
            self._replace_pol == L2Cache.LFU or
            self._replace_pol == L2Cache.FIFO):
            victim = set[0]
            ...
            if self._replace_pol == L2Cache.FIFO:
                self._update_use(victim, set)
        elif self._replace_pol == L2Cache.RAND:
            ...
            if line.use < self._mapping_pol:
                ...
                for other in set:
                    if other is not line and other.use > use:
                        other.use -= 1
        elif self._replace_pol == L2Cache.LFU:
                line.use += 1
